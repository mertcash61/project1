...
<html lang="tr">
  <head>
    ...
    <title>Multi Page Sample | Hakkımızda</title>
        ...
        <div class="row">
            <header class="col-12">
                      ...
                      <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                        ...
                        <div class="offcanvas-body">
                          ...
                          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                              <a class="nav-link active fw-bold text-warning" href="about.html">
              ...
              <section class="col-12" style="margin-top: 10vh;">
                ...
                <h1 class="text-center text-white">BURASI HAKKIMIZDA SAYFASI</h1>
              </section>
